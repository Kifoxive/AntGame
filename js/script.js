...
let lifeScore = 100,
  lifeContainer = document.querySelector(".lifePoints"),
  lifeElem = document.querySelector(".lifePoints > p"),
  lifeYellowElem = document.querySelector(".lifePoints > span"),
...
if (is_touch_enabled()) {
  container.classList.add("__mobile")
  lifeContainer.classList.add("__mobile")
  scoreElem.classList.add("__mobile")
}
...
let leftBtn = document.querySelector(".btn-left"),
  ...
  spaceBtn = document.querySelector(".btn-space")

leftBtn.addEventListener("click", () => direction({ keyCode: 37 }))
upBtn.addEventListener("click", () => direction({ keyCode: 38 }))
rightBtn.addEventListener("click", () => direction({ keyCode: 39 }))
downBtn.addEventListener("click", () => direction({ keyCode: 40 }))
spaceBtn.addEventListener("click", () => direction({ keyCode: 32 }))
